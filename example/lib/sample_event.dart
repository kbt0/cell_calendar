...
List<CalendarEvent> sampleEvents() {
  ...
  final sampleEvents = [
    ...
    CalendarEvent(eventName: "Play soccer", eventDate: today.add(Duration(days: -7)), eventColorId: 3),
    ...
    CalendarEvent(eventName: "公園で散歩", eventDate: today.add(Duration(days: -7)), eventColorId: 4),
    ...
    CalendarEvent(eventName: "Jon's Birthday", eventDate: today.add(Duration(days: 3)), eventColorId: 4),
